...
def train_model(sess, model, fields_dict,epochs=10, print_every=500):
    ...
    for e in range(epochs):
        ...
        train_data = pd.read_csv('../avazu_CTR/train_0.01.csv', chunksize=model.batch_size)
        # batch_size data
        for data in train_data:
            ...
            for i in range(actual_batch_size):
                sample = data.iloc[i,:]
                array = one_hot_representation(sample, fields_dict, train_array_length)
...
def test_model(sess, model,fields_dict, print_every = 50):
    """training model"""
...
if __name__ == '__main__':
    ...
    with tf.Session() as sess:
        ...
        train_model(sess, model, fields_train_dict,epochs=10, print_every=50)
        # print('start validation...')
        # validation_model(sess, model, print_every=100)
        # print('start testing...')
        # test_model(sess, model,fields_dict=fields_test_dict print_every=50)