...
train = pd.read_csv('../avazu_CTR/train.csv',chunksize=20000)
test = pd.read_csv('../avazu_CTR/test.csv',chunksize=20000)
...
# save dictionaries
if not os.path.exists('field2count/'):os.makedirs('field2count/')
